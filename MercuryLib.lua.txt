...
function Mercylib:BuildWatermark()
    ...
    local pingBoxWidth = 58 * scale_factor
    ...
    self.watermark_textLabel = create("TextLabel", {
        ...
        Size = UDim2.new(1, -icon_offset - 8 - pingBoxWidth, 1, 0), TextXAlignment = Enum.TextXAlignment.Left,
        Parent = self.watermark_frame
    })
    table.insert(self._gradientLabels, self.watermark_textLabel)

    -- Kotak ping terpisah, nempel di ujung kanan watermark
    self.ping_box_frame = create("Frame", {
        ...
        BorderSizePixel = 0,
        Size = UDim2.new(0, pingBoxWidth, 0, 24 * scale_factor),
        Parent = self.watermark_frame
    })
    create("UICorner", {CornerRadius = UDim.new(0, 6), Parent = self.ping_box_frame})
    ...
    self.ping_textLabel = create("TextLabel", {
        FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.SemiBold),
        TextColor3 = Color3.new(1, 1, 1), Text = "0ms", BackgroundTransparency = 1,
        Position = UDim2.new(0, 20 * scale_factor, 0, 0),
        Size = UDim2.new(1, -20 * scale_factor - 4, 1, 0), TextSize = 11 * scale_factor,
        TextXAlignment = Enum.TextXAlignment.Left,
        Parent = self.ping_box_frame
    })
